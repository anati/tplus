...
class EasyDiscussViewSubscriptions extends EasyDiscussView
{
	public function display( $tpl = null )
	{
		...
		$document->setTitle( JText::_('COM_EASYDISCUSS_PAGETITLE_SUBSCRIPTIONS') );
			...
			foreach($rows as $row)
			{
				...
				switch($row->type)
				{
					...
					case 'category':
						...
						$obj->link	= DiscussRouter::_( 'index.php?option=com_easydiscuss&view=index&category_id=' . $category->id );
						break;
					case 'user':
