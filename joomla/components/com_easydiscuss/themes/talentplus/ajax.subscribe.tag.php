...
?>
<h3><?php echo JText::sprintf('COM_EASYDISCUSS_SUBSCRIBE_TO_TAG', $tag->title); ?></h3>
<div id="subscription_container">
	<p><?php echo JText::_('COM_EASYDISCUSS_SUBSCRIBE_TAG_DESCRIPTION');?></p>
	...
	<form id="frmSubscribe" name="frmSubscribe">
		...
		?>
			...
			<div><?php echo $my->email; ?><input type="hidden" id="subscribe_email" name="subscribe_email" value="<?php echo $my->email; ?>"></div>
			<div style="clear:both;"></div>
			<input type="hidden" id="subscribe_name" name="subscribe_name" value="<?php echo $my->name; ?>">
		<?php
		} else {
		?>
			<div style="float:left; width:100px; margin-bottom:10px"><?php echo JText::_('COM_EASYDISCUSS_EMAIL');?></div>
    ...
    <div class="dialog-buttons">
        <input type="button" value="<?php echo JText::_('COM_EASYDISCUSS_BUTTON_SUBSCRIBE'); ?>" class="si_btn" onclick="discuss.subscribe.tag('<?php echo $tag->id; ?>');" />
