...
<img src="<?php echo $replyAuthorAvatar; ?>" width="80" alt="<?php echo $postAuthor; ?>" style="width:80px;height:80px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;float:left;margin:0 15px 0 0" />
