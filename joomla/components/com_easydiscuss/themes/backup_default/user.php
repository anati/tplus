	...
	<div class="user-profile clearfix">
		<div class="user-sidebar float-l">
			...
			<div class="widget user-social">
				<div class="widget-head small"><?php echo JText::_( 'COM_EASYDISCUSS_SOCIAL_PROFILES' );?></div>
				<div class="widget-body">
					<ul class="user-social reset-ul">
		...
		<div class="user-content">
			...
			<div class="user-intro mt-5 mb-10"><?php echo $profile->get( 'description' );?></div>

			<div class="user-brief small pb-10 ttu">
			...
			<div id="user-achievements" class="user-achievements clearfull mb-15 tab-item" <?php echo ( $viewType != 'user-achievements' ) ? ' style="display:none"' : ''; ?> >
