(function( $ ) {
	...
	var regs = {
		...
		str = $.String = $.extend( $.String || {} , {
			...
			// start, end starts with base 0.
			remove: function(s, start, end) {
				return s.slice(0, start) + s.slice(end);
			},

			replaceRange: function(s, start, end, newString)
			{
				return s.slice(0, start) + newString + s.slice(end);
			},
