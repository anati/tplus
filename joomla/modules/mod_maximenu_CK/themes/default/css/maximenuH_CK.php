...
div#<?php echo $id; ?> ul.maximenuCK li.level0:hover
{
    background: #f6f6f6 url(../images/separator.png) top right no-repeat;
    color: #fff !important;
...
div#<?php echo $id; ?> ul.maximenuck2 li.parent.level0 li.parent a.maximenuck:hover
{
    background : #f0f0f0 url(../images/maxi_arrow1.png) center right no-repeat;
}
div#<?php echo $id; ?> ul.maximenuck2 li.maximenuck a.maximenuck:hover
{
    background : #f0f0f0;
}
