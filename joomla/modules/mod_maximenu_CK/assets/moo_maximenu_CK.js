            ...
            element.each(function(el) {
                ...
                if (el.getElement('div.floatCK') != null) {
                    ...
                    if (style == 'clickclose') {
                        ...
                        if (el.hasClass('parent') && el.getFirst('a.maximenuCK')) el.getElement('a.maximenuCK').setProperty('href','javascript:void(0)');
    ...
    Element.extend({
        ...
        animMaxiCK: function() {
            ...
            if (this.status == 'hide')
            {
                ...
                this.showing = 0;
                this.maxiFxCK.stop();
                if (this.opentype == 'slide') this.maxiFxCK2.stop();
