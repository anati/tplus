...
?>
<div class="pa-15">
	<h3 class="head-3"><?php echo JText::_( 'COM_EASYDISCUSS_AUTOPOST_FACEEBOOK');?> - <?php echo JText::_( 'COM_EASYDISCUSS_FB_AUTOPOST_STEP_1'); ?></h3>
	<form name="facebook" action="index.php" method="post">
		...
		<input type="submit" class="button social facebook" value="<?php echo JText::_( 'COM_EASYDISCUSS_FB_AUTOPOST_NEXT_STEP' );?>" />
