...
<table class="noshow">
	<tr>
        ...
        <td width="50%" valign="top">
			<fieldset class="adminform">
			<legend><?php echo JText::_( 'COM_EASYDISCUSS_JOMSOCIAL_ACTIVITY_STREAM' ); ?></legend>
			<table class="admintable" cellspacing="1">
				<tbody>
				<tr>
					<td width="300" class="key">
				...
				<tr>
					<td width="300" class="key">
						<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_EASYDISCUSS_JOMSOCIAL_ACTIVITY_BADGES_EARNED' ); ?>::<?php echo JText::_('COM_EASYDISCUSS_JOMSOCIAL_ACTIVITY_BADGES_EARNED_DESC'); ?>">
				...
				<tr>
					<td width="300" class="key">
						<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_EASYDISCUSS_JOMSOCIAL_ACTIVITY_RANKED_UP' ); ?>::<?php echo JText::_('COM_EASYDISCUSS_JOMSOCIAL_ACTIVITY_RANKED_UP_DESC'); ?>">
