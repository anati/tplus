...
{
	window.location.href	= 'index.php?option=com_easydiscuss&view=rules&layout=install&from=rules';
}
...
<form action="index.php" method="post" name="adminForm">
	...
	<thead>
		<tr>
			...
			<th width="5"><input type="checkbox" name="toggle" value="" onClick="checkAll(<?php echo count( $this->rules ); ?>);" /></th>
