...
?>
<form action="index.php?option=com_easydiscuss" method="post" name="adminForm">
	<div class="adminform-head">
		<table class="adminform">
			<tr>
				<td width="40">
				  	<?php echo JText::_( 'COM_EASYDISCUSS_ACL_SEARCH' ); ?>
				</td>
				<td width="200">
				...
				<td width="200" style="text-align: right;">
					<?php echo JText::_( 'COM_EASYDISCUSS_ACL_FILTER_BY' ); ?>
	...
	<div class="adminform-body">
		...
		<thead>
			<tr>
				...
				<th class="title" style="width:5%;"><?php echo JText::_('COM_EASYDISCUSS_ACTION'); ?></th>
				<th class="title" style="width:1%;"><?php echo JHTML::_('grid.sort', 'COM_EASYDISCUSS_ID', 'a.`id`', $this->sort->orderDirection, $this->sort->order ); ?></th>
			</tr>
		</thead>
		<tfoot>
			<tr>
	...
	?>
			<tr class="<?php echo "row$k"; ?>">
				...
				<td class="editlinktip hasTip" title="<?php echo DiscussStringHelper::escape( $ruleset->name ); ?>::<?php echo DiscussStringHelper::escape( $tips ); ?>">
					<?php echo str_repeat('<span class="gi">|&mdash;</span>', $ruleset->level) ?>
					<a href="<?php echo JRoute::_($editlink);?>"><?php echo $ruleset->name; ?></a>
				</td>
				<td style="text-align:center;"><a href="<?php echo JRoute::_($editlink);?>"><?php echo JText::_('COM_EASYDISCUSS_EDIT');?></a></td>
				<td>
					<?php echo $ruleset->id;?>
				</td>
			</tr>
