...
{
	Foundry('#cid').val(id);
	Foundry('#aclid').html(id);
	Foundry('#aclname').val(name);
...
<form action="index.php" method="post" name="adminForm" autocomplete="off">
	<div class="adminform-body col width-45">
		<fieldset class="adminform">
		<legend><?php echo JText::_( 'COM_EASYDISCUSS_ACL_RULE_SET' ); ?></legend>
			<table class="admintable" cellspacing="1">
				<tr>
					<td width="150" class="key">
						<label for="cid"><?php echo JText::_( 'COM_EASYDISCUSS_ID' ); ?></label>
					</td>
					<td>
				...
				<tr>
					<td width="150" class="key">
						<label for="name"><?php echo JText::_( 'COM_EASYDISCUSS_ACL_NAME' ); ?></label>
					</td>
					<td>
			...
			?>
				<tr>
					...
					<td>
					    ...
					    <div class="small mts"><?php echo $this->getRuleDescription( $key ); ?></div>
					</td>
				</tr>
			<?php
			}
