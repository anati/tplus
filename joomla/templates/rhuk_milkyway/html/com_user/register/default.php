...
<!--
	Window.onDomReady(function(){
		document.formvalidator.setHandler('passverify', function (value) { 
            return jQuery('input.validate-password[type=password]').val() === value; });
	});
// -->

    // Hide the empty iframe created by reCAPTCHA; it causes alignment issues.
    jQuery(document).ready(function(){
        var $emptyCaptchaIframe = jQuery('iframe[src^=about\\:blank]');
        if( $emptyCaptchaIframe )
        {
            $emptyCaptchaIframe.hide();
        }
    });
</script>
...
By registering as a user on this site, you may be contacted by Talent Plus.
</div>
